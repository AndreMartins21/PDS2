...
private:
    std::string m_combinado;    // Item escolhido da comida japonesa
    int m_sushis;               // Quantidade de sushis
    int m_temakis;              // Quantidade de temakis
    int m_hots;                 // Quantidade de hots
};
